...
$lang = array_merge(
	$lang, array(
		...
		'ACP_AJAXSHOUTBOX_PUSH_DISABLED'            => 'Push features uitgeschakeld',
		'ACP_AJAXSHOUTBOX_PUSH_DISABLED_EXPLAIN'    => 'De push features zijn, standaard, uitgeschakeld. Wanneer je deze functionaliteit wilt inschakelen voeg je de volgende code toe aan je config.php:',
	)
);
