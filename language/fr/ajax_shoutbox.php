...
$lang = array_merge(
	$lang, array(
		...
		'AJAX_SHOUTBOX_CONNECTION_INFO'   => 'Information de connexion pour l’application Shoutbox',
		'AJAX_SHOUTBOX_PUSH_DISABLED'    => 'Tentative d’appel de la fonction « PUSH » alors que cette fonctionnalité est désactivée. Cela ne devrait pas se produire.',
		'AJAX_SHOUTBOX_CONNECTIONID'     => 'Ajouter un nouveau forum dans l’application et saisir dans %s l’ID de connexion, ou scanner le code QR ci-dessous.',
